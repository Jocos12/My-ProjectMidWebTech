...
<body>
    ...
    %>
      ...
      <div class="mtn">
        <a href="ListDepSem.jsp" class="more-info-link"
            style="font-family: 'Gabriola', cursive; font-size: 24px; color: #4285f4;">B. List of Students per Department and Semester</a>
    </div>
</body>
</html>
